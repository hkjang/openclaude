# OpenClaude 권한 및 보안 매트릭스

## 1. 문서 목적

이 문서는 OpenClaude의 권한 모드, 규칙 우선순위, 파일시스템 보호, 관리형 정책, 원격 모드 제한을 한 문서에서 볼 수 있도록 만든 소스 기준 보안 운영 가이드입니다.
...
OpenClaude의 권한 시스템은 단일 스위치가 아니라 여러 계층이 겹쳐 동작합니다.
...
- [openclaude-auth-credential-guide-ko.md](D:/project/openclaude/docs/openclaude-auth-credential-guide-ko.md)

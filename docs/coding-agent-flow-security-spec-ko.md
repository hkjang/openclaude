...
이 문서는 코딩 에이전트의 내부 데이터 흐름, 실행 흐름, 보안 제어, 오류 및 예외 처리 방식을 별도로 설명하는 구현/운영 보조 문서다. 아키텍처 전체 설명은 [coding-agent-architecture-spec-ko.md](D:/project/openclaude/docs/coding-agent-architecture-spec-ko.md)를 기준으로 한다.
...
- 상위 아키텍처 문서: [coding-agent-architecture-spec-ko.md](D:/project/openclaude/docs/coding-agent-architecture-spec-ko.md)
- 제품 기준 문서: [openclaude-functional-spec-ko.md](D:/project/openclaude/docs/openclaude-functional-spec-ko.md)

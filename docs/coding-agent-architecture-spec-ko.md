...
- 데이터 흐름/보안/오류 처리 문서: [coding-agent-flow-security-spec-ko.md](D:/project/openclaude/docs/coding-agent-flow-security-spec-ko.md)
- OpenClaude 제품 기준 문서: [openclaude-functional-spec-ko.md](D:/project/openclaude/docs/openclaude-functional-spec-ko.md)

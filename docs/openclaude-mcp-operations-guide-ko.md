# OpenClaude MCP 운영 가이드

## 1. 문서 목적

이 문서는 OpenClaude의 MCP Model Context Protocol 서버를 실제 운영과 유지보수 관점에서 정리한 가이드다.  
...
- [플러그인 및 훅 추가 가이드](D:/project/openclaude/docs/openclaude-plugin-hook-guide-ko.md)
- [권한 / 보안 매트릭스](D:/project/openclaude/docs/openclaude-permission-security-matrix-ko.md)
- [오류 메시지 카탈로그](D:/project/openclaude/docs/openclaude-error-catalog-ko.md)
...
OpenClaude가 다루는 MCP scope 는 아래와 같다.
